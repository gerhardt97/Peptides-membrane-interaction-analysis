% Partition coefficients of antimicrobial peptides by fluroescence spectrum measurement

clc,clear
syms w t

L1=[0;1;3;5;7;9;11;13;15;20] % Peptides concentration normally as μM
F1=[1;1.017946162;1.064805583;1.121635095;1.28115653;1.307577268;
    1.479062812;1.51894317;1.558325025;1.610667996]; % F/F0 values at different peptides' concentration
f1=fittype(['4.005-3.005*(1/(1+a*w))'],'independent','w','coefficients',{'a'});
cfun=fit(L1,F1,f1)
Li=0:0.1:20;
Fi=cfun(Li);
...
f2=fittype(['15.09-14.09*(1/(1+b*t))'],'independent','t','coefficients',{'b'});
cfun=fit(L2,F2,f2)
Lii=0:0.1:20;
Fii=cfun(Lii);
